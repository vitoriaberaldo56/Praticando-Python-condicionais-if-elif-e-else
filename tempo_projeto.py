...
a = int(input('Digite a quantidade de dias para a tarefa A: '))
b = int(input('Digite a quantidade de dias para a tarefa B: '))
c = int(input('Digite a quantidade de dias para a tarefa C: '))
...
if a < 0 or b < 0 or c < 0:
    ...
    print(f'Total gasto nas atividades {soma}')